abstract class StringValues {
  ...
  static const helpSettingsHelp =
      "Get help from NCEC support and report any bug or problem.";
  ...
  static const verificationDescription =
      "Here's everything you need to know about verification on NCEC and how to get verified.";

  static const verificationDescription2 =
      'A verified badge on NCEC means that an account of public interest is authentic. It lets people know that an account of public interest is the authentic presence of the public figure, celebrity, or global brand it represents. Verified accounts are marked by a badge on NCEC.';
  ...
  static const verifiedAccountHelp =
      'This account is verified by NCEC. It means that this account is authentic.';
  ...
  static const whyAreYouReportingThisDesc =
      'Your report will be sent to NCEC team. Please provide a reason for reporting this. This will help us to take action on this. Your report will be anonymous.';
